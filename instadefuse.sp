...
{
	name = "CloudiaNs-Insta-Defuse",
	description = "Plugin to instantly defuse the bomb when no T's are alive and other circumstances. Made from Jacoblairm's plugin",
	author = "Jacoblairm",
	version = "1.2",
